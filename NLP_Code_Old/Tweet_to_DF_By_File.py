...
for json_file in json_files:
    ...
    for tweet in tweets_data:     
        ...
        data.append([username, date, time_of_day, full_tweet_text, cleaned_text_str, num_tweets, num_chars, num_words, num_sents, num_vocab, ner_entities, entity_sentiment_scores])    

    # Create a DataFrame from the collected data
    columns = ['username', 'date', 'time', 'full_tweet_text', 'cleaned_text', 'num_tweets', 'num_chars', 'num_words', 'num_sents', 'num_vocab', 'ner_entities', 'entity_sentiment_scores']
